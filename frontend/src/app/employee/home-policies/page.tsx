...
import { listEmployeeHomePolicies } from "@/lib/queries";
import type { Policy } from "@/types/database";

export default function EmployeeHomePoliciesPage() {
  const [rows, setRows] = useState<Policy[]>([]);
  const [loading, setLoading] = useState(true);
  const [error, setError] = useState<string | null>(null);

  useEffect(() => {
    listEmployeeHomePolicies()
      .then(setRows)
  ...
  return (
    <AppShell role="employee" title="Home Policies" eyebrow="Book of business">
